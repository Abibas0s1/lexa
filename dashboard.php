...
<section class="dashboard">
   ...
   <h1 class="heading">характеристика</h1>
   ...
   <div class="box">
      ...
      <a href="users_accounts.php" class="btn">посмотреть клиентов</a>
   </div>
   ...
   <div class="box">
      ...
      <p>администраторы</p>
      <a href="admin_accounts.php" class="btn">посмотреть администраторов</a>
   </div>
