...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="введите свой старый пароль" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="password" name="confirm_pass" placeholder="подтвердите свой новый пароль" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
